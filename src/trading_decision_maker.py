...
=== 선물 시장 신호 ===
• 시장 편향: {market_data['futures_bias']}
• 가격 안정성: {market_data['futures_stability']}
...
📌 판단 시 고려사항:
1. 선물 시장의 신호가 현물 시장과 일치하는지 확인
2. 시장 안정성이 "불안정"일 경우 리스크 관리를 더욱 엄격하게 적용
3. 프리미엄/디스카운트와 펀딩비율의 방향성이 매매 판단의 중요한 근거가 됨
4. 시장 편향의 반대 방향으로의 기회 포착 가능성 검토

📌 전체적인 판단은 **명확하고 단호해야 하며**,  
